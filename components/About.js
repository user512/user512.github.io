...
const About = () => {
  return (
    <div id="about" className="container">
      <h1>About me</h1>
      <div>
        <p>I am a software engineer trying to learn many things.</p>
        ...
        <p>I am not a ninja/ rockstar but I am open minded to new technologies and always get stuff done.</p>
      </div>
    </div>
  )
}
